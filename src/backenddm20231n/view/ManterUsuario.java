...
public class ManterUsuario {
    ...
    private static void inserir() throws SQLException, ClassNotFoundException {
        ...
        Object[] selectionVal = { "ATIVO", "INATIVO"};
        String initialSel = "ATIVO";
        Object status = JOptionPane.showInputDialog(null, "Inativo ou Ativo?",
        "STATUS", JOptionPane.QUESTION_MESSAGE, null, selectionVal, initialSel);
        
        Object[] selectionValues = { "ADM", "VISITANTE"};
        String initialSelection = "ADM";
        Object tipo = JOptionPane.showInputDialog(null, "Qual é o tipo?",
        "TIPO", JOptionPane.QUESTION_MESSAGE, null, selectionValues, initialSelection);
        
        Usuario usuEnt = new Usuario(login,senha,(String) status, (String) tipo);
        ControllerUsuario contUsu = new ControllerUsuario();
